...
const Careers = () => {
  ...
  return (
    ...
    <div className='w-[97%] m-auto border p-[10px] rounded-[15px] border-[#1F1F1F] mt-[100px]'>
      <h1 className='text-[30px] lg:text-[50px] bg-[#1A1A1A] rounded-[15px] px-[25px] py-[20px] w-[100%]'><b>Join Our Team at NexGen</b></h1>
    ...
    <div className='w-[97%] m-auto border p-[10px] rounded-[15px] border-[#1F1F1F] mt-[100px]'>
      <h1 className='text-[30px] lg:text-[50px] bg-[#1A1A1A] rounded-[15px] px-[25px] py-[20px] w-[100%]'><b>How to Apply</b></h1>
      ...
      <div className='mt-[25px] flex justify-around items-center flex-wrap gap-[25px]'>
        <div className='bg-[#1A1A1A] p-[25px] rounded-[15px] lg:w-[23%]'>
          <p>Step 01</p>
          <br/>
          <h3 className='text-[20px] bg-[#1F1F1F] w-[100%] p-[25px]'>Explore Job Listings</h3>
          <br/>
          <p>Visit our website's "Careers" page to explore the current job listings. Review the various roles available and select the position that aligns with your skills, experience, and career aspirations.</p>
          <br/>
          <div className='flex items-center gap-[15px]'>
            <img src={down} alt="" />
            <p>Know More</p>
